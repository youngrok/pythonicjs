##############################
Pythonic JavaScript Code Guide
##############################

The practices of modern JavaScript are too complicated and ugly. JavaScript can be simpler and cleaner if following the practices of Python. Python has excellent guides for good codes, `PEP 8 <https://www.python.org/dev/peps/pep-0008/>`_ and `PEP 20 <https://www.python.org/dev/peps/pep-0020/>`_. They are good for JavaScript, too.

*********************************************************************************************
Style Guide for JavaScript Code - from `PEP 20 <https://www.python.org/dev/peps/pep-0020/>`_
*********************************************************************************************
